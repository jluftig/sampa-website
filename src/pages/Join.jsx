...
export default function Join() {
  ...
  const headerSub = (() => {
    ...
    return user
      ...
      : 'Choose your level, sign in (one click, no password), pick a term, then pay. Active membership includes the member networking directory and supports SAMPA’s policy work for quality care and MOUD access.';
  })();
