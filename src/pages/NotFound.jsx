  ...
  return (
    <div className="relative min-h-screen bg-background text-text">
      ...
      <main className="max-w-2xl mx-auto px-4 pt-40 pb-24 text-center">
        <div className="text-primary font-bold font-data tracking-widest text-sm mb-4 uppercase">404</div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          ...
          <Link to="/news" className="px-6 py-3 rounded-full border border-primary/20 font-semibold hover:bg-primary hover:text-white transition-colors">
            Read the news
          </Link>
        </div>
      </main>
