-- ============================================================================
-- Practice settings directory filter (2026-08-07)
-- HOW TO RUN: Supabase Dashboard -> SQL Editor -> paste this whole file -> Run.
-- Additive + idempotent (safe to re-run). Mirror of the sections updated in
-- supabase/schema.sql (source of truth). Run BEFORE deploying code that
-- depends on member_directory(..., settings_filter).
--
-- Extends member_directory with optional settings_filter text[] (OR match
-- against organizations[].practice_settings jsonb arrays). Search also hits
-- practice_settings slugs and practice_setting_other. No new columns —
-- structured settings live in organizations jsonb.
-- ============================================================================

-- Drop both arities so recreate is clean (return shape unchanged; arg list grew).
