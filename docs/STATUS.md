...
|----|------|-------|---------|-------|
| T3 | Brevo email — campaigns + first real send path | egg | 2026-08-07 | **Claimed egg.** Lifecycle welcome/renewal/donation + DOI **LIVE**. Weekly #01 sent **#23** (Updates) + **#24** catch-up. Join/renewal → Updates (PR #94). |
| T42 | Admin roster: Newsletter (Updates) tab | egg | 2026-08-29 | Footer DOI list is Brevo-only today. PR: `/editor/members` tab reads Updates (same member-viewer gate). Preview before merge. |
