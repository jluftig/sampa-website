...
**Last updated:** 2026-09-03 (T45 — Board meetings monthly HTML + AAPA-style hub tabs, PR #97)
...
|----|------|-------|---------|-------|
| T45 | Board meeting agenda + minutes pages in the member-only area | cursor | 2026-09-03 | **Claimed cursor.** Preview PR **#97** — do not merge. Hub: Agendas / Records / Schedule tabs. **Posted HTML:** Sep 9 2026 agenda (minutes not yet); Jul 8 agenda+minutes; Aug 2026 minutes (August.docx was filed under Agenda); Apr 8 2026 minutes. **On file:** 2026 Jan–Mar/May–Jun agendas+minutes; Aug agenda; 2026 annual PDF; 2025 Feb/Jun/Jul/Aug/Sep minutes. Gated `is_active_member()`. |
