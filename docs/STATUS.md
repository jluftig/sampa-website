...
**Last updated:** 2026-08-19 (T23 Josh copy pass: Didgwalic + drop preview chrome on PR #77)
...
|----|------|-------|---------|-------|
| T23 | Public About/Leadership page (form bios preview) | cursor | 2026-08-13 | **Claimed cursor.** `/about` rewrite on **draft PR #77**. 2026-08-19 Josh copy: Lamont clinic → Didgwalic Wellness Center; strip all public preview chrome (banner, Preview chip, first-pass / not-a-ship copy). Page reads as 2026–27 leadership. Danielle omitted. **Do not merge / do not publish.** |
...
- **About / Leadership section (T23 · cursor)** — `/about` rewrite on **draft PR #77**. 2026-08-19 Josh copy: Didgwalic + public preview chrome removed. Do not merge. Separate-page experiment remains at PR #71.
...
- [ ] **About / Leadership section (T23 · cursor in progress)** — `/about` rewrite on PR #77. 2026-08-19 Josh copy: Didgwalic + public preview chrome removed. Vercel preview only; do not ship to production.
