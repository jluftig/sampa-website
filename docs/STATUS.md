...
**Last updated:** 2026-08-19 (T23 public headshots + third-person bios on PR #77 — preview only)
...
|----|------|-------|---------|-------|
| T23 | Public About/Leadership page (form bios preview) | cursor | 2026-08-13 | **Claimed cursor.** `/about` rewrite on **draft PR #77**. 2026-08-19: Josh public headshots for Debra, Jim, Jordan (wave-shirt), Kerith, Lamont, Megan, Tasha; Edward form bio first-person → third-person only; preview note no longer waits on per-person photo okay. Baker/Cohen/Kelsy photos unchanged. Danielle omitted. Vacant seats empty. Preview only — **do not merge / do not publish.** |
...
- **About / Leadership section preview (T23 · cursor)** — `/about` rewrite on **draft PR #77**. 2026-08-19 public headshots + Edward third-person bio. Do not merge. Separate-page draft remains at PR #71.
...
- [ ] **About / Leadership section (T23 · cursor in progress)** — `/about` rewrite on PR #77. 2026-08-19 public headshots + Edward third-person bio. Vercel preview only; do not ship to production.
