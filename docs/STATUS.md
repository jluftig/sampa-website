...
**Last updated:** 2026-08-18 (T23 last four survey photos: Shani, Josh, Eric, Edward — preview PR only)
...
|----|------|-------|---------|-------|
| T23 | Public About/Leadership page (form bios preview) | cursor | 2026-08-13 | **Claimed cursor.** First-pass **on `/about#leadership`**. Official 2026–27 roles. Eleven form submitters have submitted bios and survey photos (Shani, Josh, Eric, Edward added 2026-08-18 from the shared Drive folder). Danielle omitted. **Draft PR #77** — preview only, **do not merge / do not publish.** |
...
- **About / Leadership section preview (T23 · cursor)** — first-pass roster on existing `/about` (`#leadership`). Official 2026–27 roles + submitted form bios for the 11 who gave website permission. Survey photos now on all 11 submitters, including Shani, Josh (replaced Bridge quilted-jacket file), Eric, and Edward. **Draft PR #77**; do not merge. Separate-page draft remains at PR #71.
...
- [ ] **About / Leadership section (T23 · cursor in progress)** — form bios on `/about#leadership` (2026-08-18). All 11 submitter survey photos now on the preview, including Shani, Josh, Eric, and Edward. Vercel preview via PR #77; do not ship to production.
