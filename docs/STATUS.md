...
**Last updated:** 2026-09-24 (T57 draft PR #113 `/editor/policy`; T58 org dashboard four pillars, draft PR #112)
...
|----|------|-------|---------|-------|
| T57 | Internal PHP committee work tracker | cursor | 2026-09-24 | **Claimed cursor.** Draft PR #113. `/editor/policy` is the committee response tracker. Seed is the three 2026 sheet rows in `src/data/policyWork.js`. Gate `canViewPolicyWork` is admin, `can_view_members`, or `is_board`. Not public `/policy` and not parked T19. Preview only. Do not merge until Website QA and Josh. |
