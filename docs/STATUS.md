...
**Last updated:** 2026-09-02 (T43 claimed — ASAM policy PDF logo + source link)
...
|----|------|-------|---------|-------|
| T43 | ASAM policy polish: source PDF link + SAMPA logo on comment PDF | cursor | 2026-09-02 | **Claimed cursor.** Hub “Download the PDF” → ASAM official standards URL; logo above addictionpas.org on SAMPA comment PDF. |
